...
/* FreeRTOS includes. */
#include "FreeRTOS.h"
/* fork-aivision: task.h is required because configASSERT (defined in
 * FreeRTOSConfig.h) expands to taskDISABLE_INTERRUPTS(), which lives in
 * task.h. Upstream relied on transitive resolution from elsewhere. */
#include "task.h"
