...
#include "ice_api.h"
/* fork-aivision: dropped upstream's #include "signaling_controller.h" --
 * this file references zero symbols from it (verified by grep), and we
 * use our own signaling layer instead of upstream's. */
